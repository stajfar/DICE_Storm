...
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters {
	...
	protected EClass eStaticClass() {
		return Tosca_yaml_standardPackage.Literals.PARAMETERS;
	}
	...
	public EList<Parameter> getParemeters_hasParameter() {
		if (paremeters_hasParameter == null) {
			paremeters_hasParameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, Tosca_yaml_standardPackage.PARAMETERS__PAREMETERS_HAS_PARAMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tosca_yaml_standardPackage.PARAMETERS__PAREMETERS_HAS_PARAMETER:
