...
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	...
	protected EClass eStaticClass() {
		return Tosca_yaml_standardPackage.Literals.REQUIREMENT;
	}
	...
	public void setRequirement_name(String newRequirement_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca_yaml_standardPackage.REQUIREMENT__REQUIREMENT_NAME, oldRequirement_name, requirement_name));
	}
	...
	public void setNode(String newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca_yaml_standardPackage.REQUIREMENT__NODE, oldNode, node));
	}
	...
	public void setCapability_Type_name(String newCapability_Type_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca_yaml_standardPackage.REQUIREMENT__CAPABILITY_TYPE_NAME, oldCapability_Type_name, capability_Type_name));
	}
	...
	public EList<String> getOccurances() {
		if (occurances == null) {
			occurances = new EDataTypeUniqueEList<String>(String.class, this, Tosca_yaml_standardPackage.REQUIREMENT__OCCURANCES);
		}
		return occurances;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tosca_yaml_standardPackage.REQUIREMENT__REQUIREMENT_NAME:
				return getRequirement_name();
			case Tosca_yaml_standardPackage.REQUIREMENT__NODE:
				return getNode();
			case Tosca_yaml_standardPackage.REQUIREMENT__CAPABILITY_TYPE_NAME:
				return getCapability_Type_name();
			case Tosca_yaml_standardPackage.REQUIREMENT__OCCURANCES:
