...
import tosca_yaml_standard.Tosca_yaml_standardFactory;
 ...
 * @generated
 */
public class Tosca_yaml_standardPackageImpl extends EPackageImpl implements Tosca_yaml_standardPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see tosca_yaml_standard.Tosca_yaml_standardPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Tosca_yaml_standardPackageImpl() {
		super(eNS_URI, Tosca_yaml_standardFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Tosca_yaml_standardPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Tosca_yaml_standardPackage init() {
		if (isInited) return (Tosca_yaml_standardPackage)EPackage.Registry.INSTANCE.getEPackage(Tosca_yaml_standardPackage.eNS_URI);

		// Obtain or create and register package
		Tosca_yaml_standardPackageImpl theTosca_yaml_standardPackage = (Tosca_yaml_standardPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Tosca_yaml_standardPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Tosca_yaml_standardPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theTosca_yaml_standardPackage.createPackageContents();

		// Initialize created meta-data
		theTosca_yaml_standardPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTosca_yaml_standardPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Tosca_yaml_standardPackage.eNS_URI, theTosca_yaml_standardPackage);
		return theTosca_yaml_standardPackage;
	}
	 ...
	 * @generated
	 */
	public Tosca_yaml_standardFactory getTosca_yaml_standardFactory() {
		return (Tosca_yaml_standardFactory)getEFactoryInstance();
	}
...
} //Tosca_yaml_standardPackageImpl
