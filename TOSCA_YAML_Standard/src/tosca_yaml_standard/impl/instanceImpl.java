 ...
 * </p>
 * <ul>
 *   <li>{@link tosca_yaml_standard.impl.instanceImpl#getDeploy <em>Deploy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class instanceImpl extends MinimalEObjectImpl.Container implements instance {
	...
	protected EClass eStaticClass() {
		return Tosca_yaml_standardPackage.Literals.INSTANCE;
	}
	...
	public void setDeploy(int newDeploy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca_yaml_standardPackage.INSTANCE__DEPLOY, oldDeploy, deploy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tosca_yaml_standardPackage.INSTANCE__DEPLOY:
				return getDeploy();
		}
