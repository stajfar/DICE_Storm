...
public abstract class AbstractJsonDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == Tosca_yaml_standardPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case Tosca_yaml_standardPackage.PROPERTY_PARAMETER:
				sequence_Property_parameter(context, (Property_parameter) semanticObject); 
				return; 
	 ...
	 *     )
	 */
	protected void sequence_Connected_to(EObject context, Connected_to semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_Contained_in(EObject context, Contained_in semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_Interface_Impl(EObject context, Interface semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_Node_template(EObject context, Node_template semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (property_name=STRING (property_hasParameters+=Property_parameter property_hasParameters+=Property_parameter*)?)
	 */
	 ...
	 */
	protected void sequence_Property_parameter(EObject context, Property_parameter semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_Relationship_Impl(EObject context, Relationship semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_Service_Template(EObject context, Service_Template semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (interface_name=STRING (hasOperation+=Operation hasOperation+=Operation*)?)
	 */
	protected void sequence_Source_interface(EObject context, Source_interface semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (interface_name=STRING (hasOperation+=Operation hasOperation+=Operation*)?)
	 */
	protected void sequence_Target_interface(EObject context, Target_interface semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
