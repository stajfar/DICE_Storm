 ...
 * generated by Xtext
 */
package org.xtext.dice.toscacloudifydsl.formatting;
...
public class JsonDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private JsonDslGrammarAccess _jsonDslGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._jsonDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._jsonDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._jsonDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._jsonDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._jsonDslGrammarAccess.getML_COMMENTRule();
